...
class CustomListener(ExpressionListener):
    ...
    # Enter a parse tree produced by ExpressionParser#multi_line_comment.
    def enterMulti_line_comment(self,  ctx: ParserRuleContext):
        print("multiline comment"+ctx.getText())
